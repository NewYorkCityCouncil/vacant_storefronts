...
m <- councildown::leaflet() %>%
  addPolygons(data = boro, stroke = T, fillOpacity = 0, 
  ...
  addPolygons(data = vacant_nta.shp, 
              ...
              stroke = TRUE,
              fillOpacity = 1,
              popup = paste0("NTA Name: ", vacant_nta.shp$ntaname, " (", vacant_nta.shp$nta,")", 
                            "</br>", "Number Vacant: ", vacant_nta.shp$count, 
                            "</br>" ,"Percent Vacant: ", vacant_nta.shp$vacant_2021,"%")) %>% 
